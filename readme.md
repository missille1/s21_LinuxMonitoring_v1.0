...
Написал bash-скрипт. Скрипт запускается с одним параметром. Параметр текстовый.  
...
Написал bash-скрипт. Скрипт должен вывести на экран информацию в виде:
...
Написал bash-скрипт. За основу возьми скрипт из [**Part 2**] и убери из него часть, ответственную за сохранение данных в файл.
...
Написал bash-скрипт. За основу возьми скрипт из [**Part 3**]. Обозначения цветов аналогичные.  
...
Написал bash-скрипт. Скрипт запускается с одним параметром.  
